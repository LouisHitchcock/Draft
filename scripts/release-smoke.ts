...
files:
  - url: Draft-macOS-9.9.9-smoke.0-arm64.zip
    sha512: arm64zip
    size: 125621344
  - url: Draft-macOS-9.9.9-smoke.0-arm64.dmg
    sha512: arm64dmg
    size: 131754935
path: Draft-macOS-9.9.9-smoke.0-arm64.zip
sha512: arm64zip
...
`,
  ...
  writeFileSync(
    ...
    `version: 9.9.9-smoke.0
files:
  - url: Draft-macOS-9.9.9-smoke.0-x64.zip
    sha512: x64zip
    size: 132000112
  - url: Draft-macOS-9.9.9-smoke.0-x64.dmg
    sha512: x64dmg
    size: 138148807
path: Draft-macOS-9.9.9-smoke.0-x64.zip
sha512: x64zip
...
try {
  ...
  assertContains(
    mergedManifest,
    "Draft-macOS-9.9.9-smoke.0-arm64.zip",
    "Merged manifest is missing the arm64 asset.",
  );
  assertContains(
    mergedManifest,
    "Draft-macOS-9.9.9-smoke.0-x64.zip",
  ...
  const checksumAssetPath = resolve(
    tempRoot,
    "release-assets",
    "Draft-linux-9.9.9-smoke.0-x86_64.AppImage",
  );
