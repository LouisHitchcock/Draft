...
files:
  - url: Draft-macOS-0.0.12-fork.2-arm64.zip
    sha512: arm64zip
    size: 10
  - url: Draft-macOS-0.0.12-fork.2-arm64.dmg
    sha512: arm64dmg
    size: 11
path: Draft-macOS-0.0.12-fork.2-arm64.zip
sha512: arm64zip
...
`,
  ...
  const x64 = parseMacUpdateManifest(
    `version: 0.0.12-fork.2
files:
  - url: Draft-macOS-0.0.12-fork.2-x64.zip
    sha512: x64zip
    size: 12
  - url: Draft-macOS-0.0.12-fork.2-x64.dmg
    sha512: x64dmg
    size: 13
path: Draft-macOS-0.0.12-fork.2-x64.zip
sha512: x64zip
...
describe("merge-mac-update-manifests electron-updater compatibility", () => {
  it("selects the x64 zip for x64 macOS hosts", async () => {
    ...
    ).resolves.toContain("Draft-macOS-0.0.12-fork.2-x64.zip");
  });
  ...
  it("selects the arm64 zip for native arm64 macOS hosts", async () => {
    ...
    ).resolves.toContain("Draft-macOS-0.0.12-fork.2-arm64.zip");
  });
