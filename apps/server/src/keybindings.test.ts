import { KeybindingCommand, KeybindingRule, KeybindingsConfig } from "@draft/contracts";
    ...
    Layer.provideMerge(
      Layer.effect(
        ...
        Effect.gen(function* () {
          ...
          const dir = yield* fs.makeTempDirectoryScoped({ prefix: "draft-server-config-test-" });
