...
function getAppearanceCopy(language: AppLanguage) {
  if (language === "fa") {
    return {
      sectionTitle: "ظاهر",
      sectionDescription:
        "پالت پایه روشن و تیره، تایپوگرافی و کنترل های ظاهری Draft را برای وب و Electron تنظیم کنید.",
      themeMode: {
      ...
      uiFontSizeDescription: "اندازه پایه مورد استفاده در رابط Draft را تنظیم می کند.",
      ...
      importDialogFootnote: (themeName: string) =>
        `Draft فقط مقادیر ${themeName} فعلی را درون ریزی می کند.`,
      cancel: "لغو",
  ...
  return {
    ...
    sectionDescription:
      "Customize Draft's base light and dark palettes, typography, and interactive chrome across web and Electron.",
    themeMode: {
    ...
    uiFontSizeDescription: "Adjust the base size used across the shared Draft interface.",
    ...
    importDialogFootnote: (themeName: string) =>
      `Draft only imports the current ${themeName} values.`,
    cancel: "Cancel",
