...
export const CursorIcon = WarpIcon;

export const SublimeTextIcon: Icon = (props) => (
  <svg {...props} viewBox="0 0 24 24" fill="none">
    <path
      d="M3.5 7.25C3.5 6.56 4.06 6 4.75 6H19.25C19.94 6 20.5 6.56 20.5 7.25V9.1L9 11.5L20.5 13.9V16.75C20.5 17.44 19.94 18 19.25 18H4.75C4.06 18 3.5 17.44 3.5 16.75V14.9L15 12.5L3.5 10.1V7.25Z"
      fill="currentColor"
    />
  </svg>
);
